...
export const HeroProductVisual: React.FC = () => {
  ...
  return (
    <section id="hero-visual" className="relative pt-4 pb-12 sm:pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 dark:bg-zinc-900 border border-slate-200/80 dark:border-white/[0.08] text-slate-700 dark:text-zinc-300 text-xs font-semibold uppercase tracking-wider mb-3">
          <Layers className="w-3.5 h-3.5 text-indigo-600 dark:text-indigo-400" />
          <span>Unified Outreach Architecture</span>
        </div>
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.18] mb-3">
      ...
      <motion.div
        ...
        className="mb-6 overflow-x-auto pb-1 scrollbar-none"
      >
        <div className="flex items-center justify-between min-w-[780px] px-4 py-2.5 rounded-xl bg-white dark:bg-[#070707] border border-slate-200/90 dark:border-white/[0.08] shadow-2xs">
          {workflowSteps.map((step, idx) => (
            <React.Fragment key={idx}>
              <div className="flex items-center gap-2">
                <span className="w-5 h-5 rounded-full bg-slate-100 dark:bg-zinc-800 border border-slate-200 dark:border-white/[0.08] text-slate-700 dark:text-zinc-300 text-[10px] font-bold flex items-center justify-center">
                  {step.num}
                </span>
              ...
              {idx < workflowSteps.length - 1 && (
                <div className="flex items-center text-slate-300 dark:text-zinc-700 px-0.5">
      ...
      <motion.div
        ...
        className="relative rounded-2xl border border-slate-200/90 dark:border-white/[0.08] bg-white dark:bg-[#060606] shadow-lg shadow-slate-200/30 dark:shadow-none overflow-hidden"
      >
