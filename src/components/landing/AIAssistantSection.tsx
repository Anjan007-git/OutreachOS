        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-base text-slate-600 leading-relaxed font-normal">
              Instead of manually clicking through ten forms, speak directly with the built-in OutreachOS Copilot.
              It queries your contacts, inspects your document vault, extracts verified company context, and drafts production-ready outreach in seconds.
            </p>
          ...
          {/* Right Column: Realistic AI Assistant Conversational Interface */}
            ...
            <div className="rounded-2xl border border-slate-200 bg-white shadow-xl shadow-slate-200/40 overflow-hidden">
              ...
              <div className="h-12 bg-slate-900 text-white px-5 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-slate-400 mt-0.5">Gemini 2.5 Pro Context Model</div>
                  </div>
                </div>
              ...
              <div className="p-6 bg-slate-50/60 space-y-5 font-sans text-xs">
                ...
                <div className="flex items-start gap-3 justify-end">
                  <div className="max-w-md p-3.5 rounded-2xl rounded-tr-none bg-indigo-600 text-white shadow-2xs leading-relaxed font-medium">
                    Find my resume and prepare an email for the Staff Systems Engineer role at CloudScale.
                  </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="max-w-xl space-y-3">
                    <div className="p-3.5 rounded-2xl rounded-tl-none bg-white border border-slate-200 text-slate-700 shadow-2xs leading-relaxed space-y-2">
                      <p>
                        Found <strong className="text-slate-900">Anjan_Prajapati_Resume.pdf</strong> in your document vault.
                      </p>
                      <p>
                        I’ve prepared a personalized draft tailored to Sarah Lin (Staff Eng Manager at CloudScale) using verified role and recipient context:
                      </p>
                    </div>
                    ...
                    <div className="rounded-xl border border-indigo-200 bg-white p-4 shadow-sm space-y-3">
                      ...
                      <div className="p-2.5 rounded-lg bg-slate-50/80 border border-slate-200/80 text-[11px] text-slate-600 leading-relaxed italic">
                        "Hi Sarah, I saw CloudScale's recent telemetry scaling architecture updates. With 6+ years in distributed systems..."
                      </div>

                      {/* Action Confirmation Buttons */}
                      <div className="flex flex-wrap items-center gap-2 pt-1">
                        <button className="px-3.5 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-xs transition-colors shadow-2xs">
                          Review in Compose
                        </button>
                        <button className="px-3 py-1.5 rounded-lg border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 font-semibold text-xs transition-colors">
              ...
              <div className="p-3 bg-white border-t border-slate-200 flex items-center gap-2 text-xs text-slate-400">
                <input
                  type="text"
                  readOnly
                  placeholder="Ask OutreachOS to draft, personalize, or research a prospect..."
                  className="w-full bg-slate-50 px-3 py-2 rounded-lg border border-slate-200 text-slate-600 text-xs focus:outline-none cursor-default"
                />
                <button className="p-2 rounded-lg bg-slate-100 text-slate-400 cursor-default">
